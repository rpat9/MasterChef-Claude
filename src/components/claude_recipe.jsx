        ...
        <section className="card max-w-3xl mx-auto mt-8 border border-[var(--color-secondary)]" aria-live="polite">
          <h2 className="text-2xl font-semibold mb-3 mt-1 text-[color:var(--color-primary)]">MasterChef Claude Recommends: </h2>
            ...
            components={{
                ...
                ul: ({ node, ...props }) => (
                  <ul className="list-disc list-inside pl-4 space-y-2 mb-4 marker:text-[color:var(--color-accent)]" {...props} />
                ),
                ol: ({ node, ...props }) => (
                  <ol className="list-decimal pl-4 space-y-2 marker:font-bold marker:text-[color:var(--color-accent)]" {...props} />
                ),
                li: ({ node, ...props }) => (
                  <li className="ml-2 text-[color:var(--color-text)]" {...props} />
                ),
                strong: ({ node, ...props }) => (
                ...
                code: ({ node, ...props }) => (
                  <code className="bg-gray-100 px-1 py-0.5 rounded text-sm text-[var(--color-text)] font-mono" {...props} />
                ),
              }}>
                    {props.recipe}
            </ReactMarkdown>
